...
const menuArrow = document.getElementsByClassName("fa-solid fa-angle-down")[0];
const menuIcon = document.getElementsByClassName("fa-solid fa-cart-shopping")[0];
const menuIcon2 = document.getElementsByClassName("fa-solid fa-message icon")[0];
const menuIcon3 = document.getElementsByClassName("fa-clipboard-list")[0]
const resultForShopping = document.getElementsByClassName("resultForShopping")[0];
const resultForMessage = document.getElementsByClassName('resultForMessage')[0];
const resultForClipboard = document.getElementsByClassName("resultForClipboard")[0]
...
inputTag.addEventListener("keyup", (event) => {
  if (
    ...
    nagvigateAndSelectProduct(event.key);
    return
...
let indexToSelect = -1
const nagvigateAndSelectProduct = (key) => {
  if (key === "ArrowDown"){
    indexToSelect += 1;
    const productIdToSelect = filteredProducts[indexToSelect].id.toString()
    const productIteamContainerToSelect =document.getElementById(
      productIdToSelect
    )
...
/*menuArrow.addEventListener("mouseover", () => {
  resultForShopping.style.display="inline"
}) 

menuArrow.addEventListener("mouseout", ()=> {
  resultForShopping.style.display="none"
})
...
menuIcon2.addEventListener("click", ()=> {
  resultForMessage.style.display="inline"
})

menuArrow.addEventListener("mouseout", ()=> {
  resultForMessage.style.display="none"
})

menuIcon3.addEventListener("focus", ()=> {
  resultForClipboard.style.display = "inline"
})
